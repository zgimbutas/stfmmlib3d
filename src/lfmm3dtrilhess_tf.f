...
c     flat triangles. Input densities are defined on vertices of
c     triangles, output is defined on centroids.
c
...
c
c     lfmm3dtrilhesstf - Laplace FMM in R^3: evaluate all pairwise triangle
c         interactions (including self-interaction)
c
c     lfmm3dtrilhesstftarg - Laplace FMM in R^3: evaluate all pairwise
...
c
c
        subroutine lfmm3dtrilhesstf(ier,iprec,nsource,
...
c
        ...
        ifhesstarg=0
c
        call lfmm3dtrilhesstftarg(ier,iprec,nsource,
     $     triaflat,trianorm,source,
     $     ifcharge,charge,ifdipole,dipstr,dipvec,
     $     ifpot,pot,iffld,fld,ifhess,hess,
...
c
c
        subroutine lfmm3dtrilhesstftarg(ier,iprec,nsource,
     $     triaflat,trianorm,source,
     $     ifcharge,charge,ifdipole,dipstr,dipvec,
     $     ifpot,pot,iffld,fld,ifhess,hess,
     $     ntarget,target,ifpottarg,pottarg,iffldtarg,fldtarg,
...
c       The actual work is carried out in subroutine lfmm3dtrilhesstftargmain.
c
...
c
        ...
        ifevalloc=0
c
        call lfmm3dtrilhesstftargmain(ier,iprec,
     $     ifevalfar,ifevalloc,
...
c
c
        subroutine lfmm3dtrilhesstftargmain(ier,iprec,
     $     ifevalfar,ifevalloc,
