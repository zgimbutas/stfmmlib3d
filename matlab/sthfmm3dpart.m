...
if( ntarget == 0 ) 
mex_id_ = 'sthfmm3dpartself(c io int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i double[], c i int[x], c i double[], c i double[xx], c i int[x], c io double[], c io double[], c i int[x], c io double[])';
...
mex_id_ = 'sthfmm3dparttarg(c io int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i double[], c i int[x], c i double[], c i double[xx], c i int[x], c io double[], c io double[], c i int[x], c io double[], c i int[x], c i double[], c i int[x], c io double[], c io double[], c i int[x], c io double[])';
