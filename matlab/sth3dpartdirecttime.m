...
mex_id_ = 'sth3dpartdirecttime(c i int[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i double[], c i int[x], c i double[], c i double[xx], c i int[x], c io double[], c io double[], c i int[x], c io double[], c i int[x], c i double[], c i int[x], c io double[], c io double[], c i int[x], c io double[])';
