...
mex_id_ = 'st3dpartdirecttime(c i int[x], c i int[x], c i double[xx], c i int[x], c i double[], c i int[x], c i double[], c i double[xx], c i int[x], c io double[], c io double[], c i int[x], c io double[], c i int[x], c i int[x], c i double[], c i int[x], c io double[], c io double[], c i int[x], c io double[])';
[pot, pre, grad, pottarg, pretarg, gradtarg] = stfmm3d_r2012b(mex_id_, ms, nsource, source, ifsingle, sigma_sl, ifdouble, sigma_dl, sigma_dv, ifpot, pot, pre, ifgrad, grad, mt, ntarget, target, ifpottarg, pottarg, pretarg, ifgradtarg, gradtarg, 1, 1, 3, nsource, 1, 1, 3, nsource, 1, 1, 1, 1, 1, 1);
