...
mex_id_ = 'st3dpartdirecttime(i int[x], i int[x], i double[xx], i int[x], i double[], i int[x], i double[], i double[xx], i int[x], io double[], io double[], i int[x], io double[], i int[x], i int[x], i double[], i int[x], io double[], io double[], i int[x], io double[])';
[pot, pre, grad, pottarg, pretarg, gradtarg] = stfmm3d_r2012a(mex_id_, ms, nsource, source, ifsingle, sigma_sl, ifdouble, sigma_dl, sigma_dv, ifpot, pot, pre, ifgrad, grad, mt, ntarget, target, ifpottarg, pottarg, pretarg, ifgradtarg, gradtarg, 1, 1, 3, nsource, 1, 1, 3, nsource, 1, 1, 1, 1, 1, 1);
