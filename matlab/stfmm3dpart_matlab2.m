...
% fmmlib3d's lfmm3dpart/l3dpartdirect do not evaluate hessians; when
% gradients are requested, route through the hessian-capable
% lfmm3dpartquad/l3dpartquaddirect (with ifquad=0) instead
if( if_use_fmm == 1 ),
if( ifhess0 == 1 || ifhesstarg0 == 1 ),
H=lfmm3dpartquad(iprec,nsource,source,ifcharge,charge,...
        ifdipole,dipstr,dipvec,ifquad,quadstr,quadvec,...
        ifpot0,iffld0,ifhess0,...
