...
'Stokes particle FMM in R^3, half space';

tic
[U]=sthfmm3dpart(iprec,itype,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifgrad);
total_time=toc;
total_time_fmm=total_time;
speed=nsource/total_time;

'Stokes particle direct evaluation in R^3, half space';
...
ms = nsource / k;
tic
[F]=sth3dpartdirecttime(itype,ms,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifgrad);
total_time=toc;
